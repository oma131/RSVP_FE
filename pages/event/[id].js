  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="relative py-12">
        ...
        <h1 className="text-3xl tracking-tight font-extrabold text-gray-900 dark:text-gray-100 sm:text-4xl md:text-5xl mb-6 lg:mb-12">
          {event.name}
        </h1>
            ...
            {event.eventTimestamp > currentTimestamp ? (
              account ? (
                checkIfAlreadyRSVPed() ? (
                  ...
                  <button 
                    type="button"
                    className="w-ful items-center px-6 py-3 border border-transparent text-base font-medium rounded-full text-white bg-gradient-to-r from-fuchsia-500 via-red-600 to-orange-400 hover:bg-gradient-to-l from-fuchsia-500 via-red-600 to-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"                  
                    onClick={newRSVP}
                    >
